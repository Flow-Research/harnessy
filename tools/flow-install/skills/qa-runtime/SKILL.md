...
3. Store repo-specific layout, spec sources, and test roots in `.jarvis/context/profiles/qa.json`. Legacy `.harnessy/qa-profile.json`, `.flow/qa-profile.json`, and `qa/qa-profile.json` paths remain supported as fallbacks.
